                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Center(child: Text("${pageContent[index]["title"]}", style: Styles.comfortaa20semi.copyWith(color:Colors.black),)),
                      SizedBox(height: 24.h,),
                      Center(child: Text("${pageContent[index]["subtitle"]}",style: Styles.comfortaa14.copyWith(color:kPrimaryred),)),
                    ],
                  ),
                );
            }),
